...
Pod::Spec.new do |s|
  s.name             = 'ZTSearchBar'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZTSearchBar.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Jemis' => 'zhitong.cheng@esenyun.com' }
  s.source           = { :git => 'https://github.com/Jemis/ZTSearchBar.git', :tag => s.version.to_s }
